...
(function() {
  var $, AlphanumericFormanceField, CreditCardCVCField, CreditCardExpiryField, CreditCardField, CreditCardNumberField, DateDDMMMYYYYField, DateYYYYMMDDField, EmailField, FormanceField, NumberField, NumericFormanceField, OntarioDriversLicenseNumberField, OntarioOutdoorsCardNumberField, OntarioPhotoHealthCardNumberField, PhoneNumberField, PostalCodeField, formatBackTimeYYMM, formatBackUkSortCode, formatForwardSlashTimeYYMM, formatForwardTimeYYMM, formatForwardUkSortCode, formatTimeYYMM, formatUkSortCode, hasTextSelected, parseTimeYYMM, restrictTimeYYMM, restrictUkSortCode, _ref, _ref1, _ref10, _ref11, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9,
    __slice = [].slice,
  ...
  FormanceField = (function() {
    ...
    FormanceField.prototype.restrict_field = function(e) {
      ...
      new_val = new_val.replace(this.replace_regex, '');
      if (this.has_text_selected($target)) {
        return;
      }
      return this.restrict_field_callback(e, $target, old_val, input, new_val);
    };
    ...
    FormanceField.prototype.format_backspace = function(e) {
      ...
      return this.format_backspace_callback(e, $target, val);
    };
    ...
    FormanceField.prototype.end_of_text = function($target) {
      return ($target.prop('selectionStart') != null) && $target.prop('selectionStart') !== $target.val().length;
    };
  ...
  CreditCardField = (function(_super) {
    __extends(CreditCardField, _super);

    function CreditCardField() {
      _ref = CreditCardField.__super__.constructor.apply(this, arguments);
      return _ref;
    }

    CreditCardField.prototype.default_format = function() {
      return /(\d{1,4})/g;
    };

    CreditCardField.prototype.cards = function() {
      return [
        {
          type: 'maestro',
    ...
    CreditCardField.prototype.card_from_number = function(num) {
    ...
    CreditCardField.prototype.card_from_type = function(type) {
      var card, _i, _len, _ref1;
    ...
    CreditCardField.prototype.credit_card_type = function(num) {
      var _ref1;

      if (!num) {
        return null;
      }
      return ((_ref1 = this.card_from_number(num)) != null ? _ref1.type : void 0) || null;
    };

    CreditCardField.prototype.luhn_check = function(num) {
  ...
  CreditCardCVCField = (function(_super) {
    ...
    function CreditCardCVCField() {
      this.restrict_field_callback = __bind(this.restrict_field_callback, this);      _ref1 = CreditCardCVCField.__super__.constructor.apply(this, arguments);
      return _ref1;
    }

    CreditCardCVCField.prototype.restrict_field_callback = function(e, $target, old_val, digit, new_val) {
      if (new_val.length > 4) {
        return false;
      }
    };
    ...
    CreditCardCVCField.prototype.validate = function() {
      ...
      if (type) {
        return _ref2 = cvc.length, __indexOf.call((_ref3 = this.card_from_type(type)) != null ? _ref3.cvclength : void 0, _ref2) >= 0;
      } else {
  ...
  CreditCardExpiryField = (function(_super) {
    ...
    function CreditCardExpiryField() {
      ...
      this.restrict_field_callback = __bind(this.restrict_field_callback, this);      _ref2 = CreditCardExpiryField.__super__.constructor.apply(this, arguments);
      return _ref2;
    }

    CreditCardExpiryField.prototype.restrict_field_callback = function(e, $target, old_val, digit, new_val) {
      if (new_val.length > 6) {
        return false;
      }
    };
    ...
    CreditCardExpiryField.prototype.validate = function() {
      var currentTime, expiry, expiry_date, month, prefix, year, _ref3;

      expiry_date = this.parse_expiry(this.field.val());
      month = expiry_date.month;
      year = expiry_date.year;
      if (typeof month === 'object' && 'month' in month) {
        _ref3 = month, month = _ref3.month, year = _ref3.year;
      }
      if (!(month && year)) {
        return false;
      }
    ...
    CreditCardExpiryField.prototype.parse_expiry = function(expiry_string) {
      var month, prefix, val, year, _ref3;

      val = expiry_string.replace(/\s/g, '');
      _ref3 = val.split('/', 2), month = _ref3[0], year = _ref3[1];
  ...
  CreditCardNumberField = (function(_super) {
    ...
    function CreditCardNumberField() {
      this.set_card_type = __bind(this.set_card_type, this);
      this.format_backspace_callback = __bind(this.format_backspace_callback, this);
      this.format_paste_callback = __bind(this.format_paste_callback, this);
      this.format_field_callback = __bind(this.format_field_callback, this);
      this.restrict_field_callback = __bind(this.restrict_field_callback, this);      _ref3 = CreditCardNumberField.__super__.constructor.apply(this, arguments);
      return _ref3;
    }

    CreditCardNumberField.prototype.restrict_field_callback = function(e, $target, old_val, digit, new_val) {
      var card;

      card = this.card_from_number(new_val);
      if (card) {
        return new_val.length <= card.length[card.length.length - 1];
      } else {
        return new_val.length <= 16;
      }
    };
    ...
    CreditCardNumberField.prototype.format_credit_card_number = function(num) {
      var card, groups, upperLength, _ref4;
      ...
      if (card.format.global) {
        return (_ref4 = num.match(card.format)) != null ? _ref4.join(' ') : void 0;
      } else {
    ...
    CreditCardNumberField.prototype.validate = function() {
      ...
      return (_ref4 = num.length, __indexOf.call(card.length, _ref4) >= 0) && (card.luhn === false || this.luhn_check(num));
    };
  ...
  DateDDMMMYYYYField = (function(_super) {
    ...
    function DateDDMMMYYYYField() {
      ...
      this.format_forward_slash_callback = __bind(this.format_forward_slash_callback, this);
      this.format_field_callback = __bind(this.format_field_callback, this);
      this.restrict_field_callback = __bind(this.restrict_field_callback, this);      _ref4 = DateDDMMMYYYYField.__super__.constructor.apply(this, arguments);
      return _ref4;
    }

    DateDDMMMYYYYField.prototype.restrict_field_callback = function(e, $target, old_val, digit, new_val) {
      if (new_val.length > 8) {
        return false;
      }
    };
    ...
    DateDDMMMYYYYField.prototype.format_field_callback = function(e, $target, old_val, digit, new_val) {
      if ((/^\d$/.test(new_val) && (digit !== '0' && digit !== '1' && digit !== '2' && digit !== '3')) || (/^\d{2}[\s|\/]+\d$/.test(new_val) && (digit !== '0' && digit !== '1'))) {
        e.preventDefault();
        $target.val("" + old_val + "0" + digit + " / ");
      }
      if (/^\d{2}$/.test(new_val) || /^\d{2}[\s|\/]+\d{2}$/.test(new_val)) {
        e.preventDefault();
        return $target.val("" + new_val + " / ");
      }
    };
    ...
    DateDDMMMYYYYField.prototype.format_forward_slash_callback = function(e, $target, val) {
      var date, day, month, parse_day, parse_month, _ref5;
      ...
      if (parse_day.test(val) && val !== '0') {
        ...
        _ref5 = val.match(parse_month), date = _ref5[0], day = _ref5[1], month = _ref5[2];
        if (month !== '0') {
    ...
    DateDDMMMYYYYField.prototype.parse_date = function(date_string) {
      var day, month, year, _ref5;

      _ref5 = date_string != null ? date_string.replace(/\s/g, '').split('/', 3) : [NaN, NaN, NaN], day = _ref5[0], month = _ref5[1], year = _ref5[2];
  ...
  EmailField = (function(_super) {
    ...
    function EmailField() {
      _ref5 = EmailField.__super__.constructor.apply(this, arguments);
      return _ref5;
    }
  ...
  OntarioDriversLicenseNumberField = (function(_super) {
    ...
    function OntarioDriversLicenseNumberField() {
      ...
      this.format_backspace_callback = __bind(this.format_backspace_callback, this);
      this.format_field_callback = __bind(this.format_field_callback, this);
      this.restrict_field_callback = __bind(this.restrict_field_callback, this);      _ref6 = OntarioDriversLicenseNumberField.__super__.constructor.apply(this, arguments);
      return _ref6;
    }

    OntarioDriversLicenseNumberField.prototype.restrict_field_callback = function(e, $target, old_val, digit, new_val) {
    ...
    OntarioDriversLicenseNumberField.prototype.format_paste_callback = function(e, $target, val) {
      var first5, full, last5, middle5, _ref7;

      _ref7 = val.match(/^([A-Z]\d{0,4})?[\s|\-]*(\d{0,5})?[\s|\-]*(\d{0,5})?$/i), full = _ref7[0], first5 = _ref7[1], middle5 = _ref7[2], last5 = _ref7[3];
  ...
  OntarioOutdoorsCardNumberField = (function(_super) {
    ...
    function OntarioOutdoorsCardNumberField() {
      ...
      this.format_backspace_callback = __bind(this.format_backspace_callback, this);
      this.format_field_callback = __bind(this.format_field_callback, this);
      this.restrict_field_callback = __bind(this.restrict_field_callback, this);      _ref7 = OntarioOutdoorsCardNumberField.__super__.constructor.apply(this, arguments);
      return _ref7;
    }

    OntarioOutdoorsCardNumberField.prototype.restrict_field_callback = function(e, $target, old_val, digit, new_val) {
      if (new_val.length > 15) {
        return false;
      }
    };
    ...
    OntarioOutdoorsCardNumberField.prototype.format_paste_callback = function(e, $target, val) {
      var first6, full, last9, _ref8;

      _ref8 = val.match(/^(\d{6})\s*(\d{9})$/), full = _ref8[0], first6 = _ref8[1], last9 = _ref8[2];
  ...
  OntarioPhotoHealthCardNumberField = (function(_super) {
    ...
    function OntarioPhotoHealthCardNumberField() {
      ...
      this.format_backspace_callback = __bind(this.format_backspace_callback, this);
      this.format_field_callback = __bind(this.format_field_callback, this);
      this.restrict_field_callback = __bind(this.restrict_field_callback, this);      _ref8 = OntarioPhotoHealthCardNumberField.__super__.constructor.apply(this, arguments);
      return _ref8;
    }

    OntarioPhotoHealthCardNumberField.prototype.restrict_field_callback = function(e, $target, old_val, digit, new_val) {
    ...
    OntarioPhotoHealthCardNumberField.prototype.format_paste_callback = function(e, $target, val) {
      var first4, last2, matched, matched_vals, second3, third3;

      matched_vals = val.match(/^(\d{4})[\s|\-]*(\d{3})[\s|\-]*(\d{3})[\s|\-]*([A-Z]{2})$/i);
      if (matched_vals != null) {
        matched = matched_vals[0], first4 = matched_vals[1], second3 = matched_vals[2], third3 = matched_vals[3], last2 = matched_vals[4];
  ...
  PhoneNumberField = (function(_super) {
    ...
    function PhoneNumberField() {
      ...
      this.format_backspace_callback = __bind(this.format_backspace_callback, this);
      this.format_field_callback = __bind(this.format_field_callback, this);
      this.restrict_field_callback = __bind(this.restrict_field_callback, this);      _ref9 = PhoneNumberField.__super__.constructor.apply(this, arguments);
      return _ref9;
    }

    PhoneNumberField.prototype.restrict_field_callback = function(e, $target, old_val, digit, new_val) {
    ...
    PhoneNumberField.prototype.reformat_phone_number = function(phone_string) {
      var areaCode, first3, last4, phoneNumber, text, _ref10;

      phoneNumber = phone_string.replace(/\D/g, '').match(/^(\d{0,3})?(\d{0,3})?(\d{0,4})?$/);
      _ref10 = phoneNumber, phoneNumber = _ref10[0], areaCode = _ref10[1], first3 = _ref10[2], last4 = _ref10[3];
      text = '';
      if (areaCode != null) {
        text += "(" + areaCode;
      }
  ...
  PostalCodeField = (function(_super) {
    ...
    function PostalCodeField() {
      ...
      this.format_backspace_callback = __bind(this.format_backspace_callback, this);
      this.format_field_callback = __bind(this.format_field_callback, this);
      this.restrict_field_callback = __bind(this.restrict_field_callback, this);      _ref10 = PostalCodeField.__super__.constructor.apply(this, arguments);
      return _ref10;
    }

    PostalCodeField.prototype.restrict_field_callback = function(e, $target, old_val, input, new_val) {
      if (new_val.length > 6) {
        return false;
      }
    };

    PostalCodeField.prototype.format_field_callback = function(e, $target, old_val, input, new_val) {
      e.preventDefault();
      if (/^[ABCEFGHJKLMNPRSTVXY]$/i.test(new_val)) {
        $target.val(new_val);
      }
      if (/^[ABCEFGHJKLMNPRSTVXY][0-9]$/i.test(new_val)) {
        $target.val(new_val);
      }
      if (/^[ABCEFGHJKLMNPRSTVXY][0-9][ABCEFGHJKLMNPRSTVWXYZ]$/i.test(new_val)) {
        $target.val("" + new_val + " ");
      }
      if (/^[ABCEFGHJKLMNPRSTVXY][0-9][ABCEFGHJKLMNPRSTVWXYZ]\s*[0-9]$/i.test(new_val)) {
        $target.val(new_val);
      }
      if (/^[ABCEFGHJKLMNPRSTVXY][0-9][ABCEFGHJKLMNPRSTVWXYZ]\s*[0-9][ABCEFGHJKLMNPRSTVWXYZ]$/i.test(new_val)) {
        $target.val(new_val);
      }
      if (/^[ABCEFGHJKLMNPRSTVXY][0-9][ABCEFGHJKLMNPRSTVWXYZ]\s*[0-9][ABCEFGHJKLMNPRSTVWXYZ][0-9]$/i.test(new_val)) {
        return $target.val(new_val);
      }
    };
    ...
    PostalCodeField.prototype.format_backspace_callback = function(e, $target, val) {
      if (/[ABCEFGHJKLMNPRSTVWXYZ]\s+$/i.test(val)) {
        e.preventDefault();
        return $target.val(val.replace(/[ABCEFGHJKLMNPRSTVWXYZ]\s+$/i, ''));
      }
    };

    PostalCodeField.prototype.format_paste_callback = function(e, $target, val) {
      var first_part, full, second_part, _ref11;

      _ref11 = val.match(/^([ABCEFGHJKLMNPRSTVXY][0-9][ABCEFGHJKLMNPRSTVWXYZ])\s*([0-9][ABCEFGHJKLMNPRSTVWXYZ][0-9])$/i), full = _ref11[0], first_part = _ref11[1], second_part = _ref11[2];
    ...
    PostalCodeField.prototype.validate = function() {
      ...
      return /^[ABCEFGHJKLMNPRSTVXY][0-9][ABCEFGHJKLMNPRSTVWXYZ]\s*[0-9][ABCEFGHJKLMNPRSTVWXYZ][0-9]$/i.test(val);
    };
  ...
  parseTimeYYMM = function(time_string) {
    var months, years, _ref11;

    _ref11 = time_string != null ? time_string.replace(/\s/g, '').split('/', 2) : [NaN, NaN], years = _ref11[0], months = _ref11[1];
  ...
  DateYYYYMMDDField = (function(_super) {
    ...
    function DateYYYYMMDDField() {
      ...
      this.format_forward_slash_callback = __bind(this.format_forward_slash_callback, this);
      this.format_field_callback = __bind(this.format_field_callback, this);
      this.restrict_field_callback = __bind(this.restrict_field_callback, this);      _ref11 = DateYYYYMMDDField.__super__.constructor.apply(this, arguments);
      return _ref11;
    }

    DateYYYYMMDDField.prototype.restrict_field_callback = function(e, $target, old_val, digit, new_val) {
      if (new_val.length > 8) {
        return false;
      }
    };
    ...
    DateYYYYMMDDField.prototype.format_field_callback = function(e, $target, old_val, digit, new_val) {
      if ((/^\d{4}[\s|\/]+\d$/.test(new_val) && (digit !== '0' && digit !== '1')) || (/^\d{4}[\s|\/]+\d{2}[\s|\/]+\d$/.test(new_val) && (digit !== '0' && digit !== '1' && digit !== '2' && digit !== '3'))) {
        e.preventDefault();
        new_val = "" + old_val + "0" + digit;
        $target.val(new_val);
      }
      if (/^\d{4}$/.test(new_val) || /^\d{4}[\s|\/]+\d{2}$/.test(new_val)) {
        e.preventDefault();
        return $target.val("" + new_val + " / ");
      }
    };
    ...
    DateYYYYMMDDField.prototype.format_forward_slash_callback = function(e, $target, val) {
      var date, month, parse_month, year, _ref12;

      parse_month = /^(\d{4})\s\/\s(\d)$/;
      if (parse_month.test(val)) {
        _ref12 = val.match(parse_month), date = _ref12[0], year = _ref12[1], month = _ref12[2];
        if (month !== '0') {
    ...
    DateYYYYMMDDField.prototype.parse_date = function(date_string) {
      var day, month, year, _ref12;

      _ref12 = date_string != null ? date_string.replace(/\s/g, '').split('/', 3) : [NaN, NaN, NaN], year = _ref12[0], month = _ref12[1], day = _ref12[2];
      if (!((year != null) && year.length === 4)) {
        year = NaN;
      }
      day = parseInt(day, 10);
