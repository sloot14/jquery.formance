...
(function() {
  ...
  $.formance.fn.valCreditCardExpiry = function() {
    var expiry;
  ...
  $.formance.fn.validateCreditCardExpiry = function() {
  ...
  $.formance.fn.formatDDMMYYYY = function() {
    this.formance('restrictNumeric');
  ...
  $.formance.fn.valDDMMYYYY = function() {
    var date;
  ...
  $.formance.fn.validateDDMMYYYY = function() {
    var date, date_dict;

    date_dict = parseDateDDMMYYYY(this.val());
    date = this.formance('valDDMMYYYY');
  ...
  $.formance.fn.formatOntarioDriversLicenseNumber = function() {
  ...
  $.formance.validateOntarioDriversLicenseNumber = function(val) {
    var regex;
  ...
  $.formance.fn.formatOntarioOutdoorsCardNumber = function() {
    this.formance('restrictNumeric');
  ...
  $.formance.validateOntarioOutdoorsCardNumber = function(val) {
    var regex;
  ...
  $.formance.fn.formatPhoneNumber = function() {
    this.formance('restrictNumeric');
  ...
  $.formance.validatePhoneNumber = function(val) {
    if (val == null) {
      return false;
    }
    val = val.replace(/\(|\)|\s+|-/g, '');
  ...
  $.formance.fn.formatYYYYMMDD = function() {
    this.formance('restrictNumeric');
  ...
  parseDateYYYYMMDD = function(date_string) {
    var day, month, year, _ref;
  ...
  $.formance.fn.valYYYYMMDD = function() {
    var date;

    date = parseDateYYYYMMDD(this.val());
    if ((date.day == null) || isNaN(date.day)) {
      return false;
    }
    if ((date.month == null) || isNaN(date.month)) {
  ...
  $.formance.fn.validateYYYYMMDD = function() {
    var date, date_dict;

    date_dict = parseDateYYYYMMDD(this.val());
    date = this.formance('valYYYYMMDD');
    if (!((date != null) && date instanceof Date)) {
      return false;
    }
    if (date.getDate() !== date_dict.day) {
