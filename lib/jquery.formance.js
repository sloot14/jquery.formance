...
(function() {
  ...
  $.formance.ddmmyyyyVal = function(dateString) {
  ...
  $.formance.yyyymmddVal = function(dateString) {
    var day, month, year, _ref;

    _ref = dateString != null ? dateString.replace(/\s/g, '').split('/', 3) : [NaN, NaN, NaN], year = _ref[0], month = _ref[1], day = _ref[2];
    day = parseInt(day, 10);
    month = parseInt(month, 10);
    year = parseInt(year, 10);
    return {
